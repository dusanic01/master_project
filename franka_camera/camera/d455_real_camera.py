...
class Camera:
    def __init__(self):
        ...
        rospy.Subscriber('/camera/aligned_depth_to_color/image_raw', Image, self.depth_callback, queue_size=10)
        rospy.Subscriber('/camera/color/image_raw', Image, self.detection_callback, queue_size=10)
    ...
    def center_filtred(self, image, points, obj_id):
        ...
        rospy.loginfo(f"Dubina centra je: {self.depth_image[int(v),int(u)]}")
